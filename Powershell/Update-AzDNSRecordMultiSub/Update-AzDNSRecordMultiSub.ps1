<#PSScriptInfo
.Description
    Updates a DNS record for a Azure VM if the record does not match the current public ip.
    This script works across multiple subscriptions and when properly delegated via Azure Lighthouse across tenants.
.VERSION 
    1.0.0
.GUID 
